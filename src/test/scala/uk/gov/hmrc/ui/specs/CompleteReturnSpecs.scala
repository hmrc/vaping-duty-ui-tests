...
class CompleteReturnSpecs extends BaseSpec {
  ...
  Feature("Vaping Duty Complete Return Tests") {
    ...
    Scenario("Vaping Duty Journey submit return journey", VapingDutyTest, CompleteReturn, ZapAccessibility) {
      ...
      Then("User should be on the declare duty change CYA page")
      assert(
        VapingDutyPage.urlConfirmation(VapingDutyPage.changeDeclareDutyCYAUrl),
        "Expected to be on the declare duty change CYA page"
      )

      When("User clicks save and continue on the declare duty change CYA page")
      VapingDutyPage.clickSaveAndContinue()
      ...
      Then("User should be on the spoilt products change CYA page")
      assert(
        VapingDutyPage.urlConfirmation(VapingDutyPage.changeSpoiltProductsCYAUrl),
        "Expected to be on the spoilt products change CYA page"
      )

      When("User clicks save and continue on the spoilt products change CYA page")
      VapingDutyPage.clickSaveAndContinue()
      ...
      Then("User should be on the adjustment change CYA page")
      assert(
        VapingDutyPage.urlConfirmation(VapingDutyPage.changeAdjustmentCYAUrl),
        "Expected to be on the adjustment change CYA page"
      )

      When("User clicks save and continue on the adjustment change CYA page")
      VapingDutyPage.clickSaveAndContinue()
      ...
      Then("User should be on the duty suspended change CYA page")
      assert(
        VapingDutyPage.urlConfirmation(VapingDutyPage.changeDutySuspendedCYAUrl),
        "Expected to be on the duty suspended change CYA page"
      )

      When("User clicks save and continue on the duty suspended change CYA page")
      VapingDutyPage.clickSaveAndContinue()
